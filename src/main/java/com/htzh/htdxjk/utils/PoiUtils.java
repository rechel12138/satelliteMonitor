...
//    }
    ...
    public static List<Bckplan> importBckplanExcelToList(MultipartFile file) {
        List<Bckplan> bckplanList = new ArrayList<>();
        try {
                ...
                for (int k = 0; k < physicalNumberOfCells; k++) {
                    ...
                    switch (cell.getCellTypeEnum()) {
                        case STRING: {
                            ...
                            switch (k) {
                                case 0:
                                    bckplan.setBckplanSatname(cellValue);
                                    break;
                                case 1:
                                    bckplan.setBckplanStartTime(cellValue);
                                    break;
                                case 2:
                                    bckplan.setBckplanEndTime(cellValue);
                                    break;
                                case 3:
                                    bckplan.setBckplanCnt(cellValue);
                                    break;
                                case 4:
                                    bckplan.setBckplanDevname(cellValue);
                                    break;
                                case 5:
                                    bckplan.setBckplanIsDelete(cellValue);
                                    break;
                                case 6:
                                    bckplan.setBckplanState(cellValue);
                                    break;
                                case 7:
                                    bckplan.setBckplanModifyTime(cellValue);
                                    break;
                                case 8:
                                    bckplan.setBckplanMadetime(cellValue);
                                    break;
    ...
    public static List<Bsjckgzhd> importBsjckgzhdExcelToList(MultipartFile file) {
        List<Bsjckgzhd> bsjckgzhdList = new ArrayList<>();
        try {
            HSSFWorkbook workbook = new HSSFWorkbook(new POIFSFileSystem(file.getInputStream()));
            HSSFSheet sheet = workbook.getSheetAt(0);
            int physicalNumberOfRows = sheet.getPhysicalNumberOfRows();
            ...
            for (int j = 0; j < physicalNumberOfRows; j++) {
                ...
                for (int k = 0; k < physicalNumberOfCells; k++) {
                    ...
                    switch (cell.getCellTypeEnum()) {
                        case STRING: {
                            ...
                            switch (k) {
                                case 0:
                                    bsjckgzhd.setBsjckgzhdSatname(cellValue);
                                    break;
                                case 1:
                                    bsjckgzhd.setBsjckgzhdStartTime(cellValue);
                                    break;
                                case 2:
                                    bsjckgzhd.setBsjckgzhdEndTime(cellValue);
                                    break;
                                case 3:
                                    bsjckgzhd.setBsjckgzhdDevname(cellValue);
                                    break;
                ...
                bsjckgzhdList.add(bsjckgzhd);
            }

        } catch (IOException e) {
            e.printStackTrace();
        }
        return bsjckgzhdList;
    }
